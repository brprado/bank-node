...
//TODO Transferência bancaria entre contas (2) fazer dia 22/04
//FIXME Valores transferidos estão sendo concatenados
//FIXME valores transferidos da conta do pagador estão ficando negativos
...
function successfulTransfer(accountFrom, accountTo) {
  inquirer
    ...
    .then((answers) => {
      ...
      payerDataOBJ.balance = parseFloat(payerDataOBJ.balance - amount);
      receiverDataOBJ.balance = parseFloat(receiverDataOBJ.balance + amount);
